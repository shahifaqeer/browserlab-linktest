...
DIFF_PING = 1               #only diff ping A to R or A to S
...
#ROUTER_ADDRESS_GLOBAL = '192.168.1.21' #'193.51.181.101' #'132.227.127.193'
#ROUTER_ADDRESS_LOCAL = '192.168.1.1'
#CLIENT_ADDRESS = '192.168.1.173' #'192.168.1.108' #'192.168.146.128'
